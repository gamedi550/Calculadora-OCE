...
if st.session_state.mostrar_resultados:
    ...
    # Mostrar saludo personalizado si se ingresó un nombre
    ...
    if res["Estatus"] == "Libre de impuestos":
        ...
        # Generar texto limpio incluyendo el nombre del usuario
        ...
        with col1:
            # El archivo descargado llevará el nombre del pasajero si fue ingresado
